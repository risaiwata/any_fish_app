...
ActiveRecord::Schema.define(version: 2021_05_25_033746) do
  ...
  create_table "anglers", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "blogs", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["agent_id"], name: "index_blogs_on_agent_id"
  end
  ...
  create_table "posts", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["angler_id"], name: "index_posts_on_angler_id"
  end
  ...
  add_foreign_key "blogs", "agents"
  add_foreign_key "posts", "anglers"
